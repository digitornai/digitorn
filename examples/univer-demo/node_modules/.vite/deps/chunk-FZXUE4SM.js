...
// node_modules/@univerjs/data-validation/lib/es/index.js
...
var UpdateRuleType = (function(UpdateRuleType2) {
  UpdateRuleType2[UpdateRuleType2["SETTING"] = 0] = "SETTING";
  UpdateRuleType2[UpdateRuleType2["RANGE"] = 1] = "RANGE";
  UpdateRuleType2[UpdateRuleType2["OPTIONS"] = 2] = "OPTIONS";
  UpdateRuleType2[UpdateRuleType2["ALL"] = 3] = "ALL";
  return UpdateRuleType2;
})({});
function _typeof(o) {
...
var DataValidationModel = class DataValidationModel2 extends Disposable {
...
var DataValidationResourceController = class DataValidationResourceController2 extends Disposable {
...
var version = "0.25.1";
var DataValidatorRegistryScope = (function(DataValidatorRegistryScope2) {
  DataValidatorRegistryScope2["SHEET"] = "sheet";
  return DataValidatorRegistryScope2;
})({});
...
var UniverDataValidationPlugin = class UniverDataValidationPlugin2 extends Plugin {
...
_defineProperty(UniverDataValidationPlugin, "type", UniverType.UNIVER_SHEET);
UniverDataValidationPlugin = __decorate([
  __decorateParam(1, Inject(Injector)),
  __decorateParam(2, ICommandService),
  __decorateParam(3, IConfigService)
], UniverDataValidationPlugin);
var TWO_FORMULA_OPERATOR_COUNT = [DataValidationOperator.BETWEEN, DataValidationOperator.NOT_BETWEEN];
var OperatorTextMap = {
...
var DataValidatorDropdownType = (function(DataValidatorDropdownType2) {
  DataValidatorDropdownType2["DATE"] = "date";
  DataValidatorDropdownType2["TIME"] = "time";
  DataValidatorDropdownType2["DATETIME"] = "datetime";
  DataValidatorDropdownType2["LIST"] = "list";
  DataValidatorDropdownType2["MULTIPLE_LIST"] = "multipleList";
  DataValidatorDropdownType2["COLOR"] = "color";
  DataValidatorDropdownType2["CASCADE"] = "cascade";
  return DataValidatorDropdownType2;
})({});
var BaseDataValidator = class BaseDataValidator2 {
...
var DataValidationCacheService = class DataValidationCacheService2 extends Disposable {
  constructor(_commandService, _univerInstanceService, _sheetDataValidationModel) {
    ...
    _defineProperty2(this, "_cacheMatrix", /* @__PURE__ */ new Map());
    _defineProperty2(this, "_dirtyRanges$", new Subject());
    _defineProperty2(this, "dirtyRanges$", this._dirtyRanges$.asObservable());
  ...
  _initSheetRemove() {
    ...
    this.disposeWithMe(this._univerInstanceService.unitDisposed$.subscribe((univerInstance) => {
      if (univerInstance.type === UniverType.UNIVER_SHEET) this._cacheMatrix.delete(univerInstance.getUnitId());
    }));
  }
...
DataValidationCacheService = __decorate2([
  __decorateParam2(0, Inject(ICommandService)),
  __decorateParam2(1, Inject(IUniverInstanceService)),
  __decorateParam2(2, Inject(DataValidationModel))
...
var DataValidationCustomFormulaService = class DataValidationCustomFormulaService2 extends Disposable {
  constructor(_instanceSrv, _registerOtherFormulaService, _dataValidationModel, _dataValidationCacheService, _validatorRegistryService) {
    ...
    _defineProperty2(this, "_ruleFormulaMap", /* @__PURE__ */ new Map());
    _defineProperty2(this, "_ruleFormulaMap2", /* @__PURE__ */ new Map());
  ...
  _initFormulaResultHandler() {
    this.disposeWithMe(this._registerOtherFormulaService.formulaResult$.subscribe((resultMap) => {
      for (const unitId in resultMap) {
        ...
        if (this._instanceSrv.getUnitType(unitId) !== UniverType.UNIVER_SHEET) continue;
...
DataValidationCustomFormulaService = __decorate2([
  __decorateParam2(0, IUniverInstanceService),
  __decorateParam2(1, Inject(RegisterOtherFormulaService)),
  __decorateParam2(2, Inject(DataValidationModel)),
  __decorateParam2(3, Inject(DataValidationCacheService)),
  __decorateParam2(4, Inject(DataValidatorRegistryService))
...
var DataValidationListCacheService = class DataValidationListCacheService2 extends Disposable {
  constructor(_injector, _dataValidationModel) {
    super();
    this._injector = _injector;
    this._dataValidationModel = _dataValidationModel;
    _defineProperty2(this, "_cache", /* @__PURE__ */ new Map());
...
DataValidationListCacheService = __decorate2([__decorateParam2(0, Inject(Injector)), __decorateParam2(1, Inject(DataValidationModel))], DataValidationListCacheService);
var DataValidationFormulaService = class DataValidationFormulaService2 extends Disposable {
  constructor(_instanceService, _registerOtherFormulaService, _dataValidationCacheService, _dataValidationModel, _validatorRegistryService, _listCacheService) {
    ...
    _defineProperty2(this, "_formulaRuleMap", /* @__PURE__ */ new Map());
    this._initFormulaResultHandler();
  }
  _initFormulaResultHandler() {
    this.disposeWithMe(this._registerOtherFormulaService.formulaResult$.subscribe((resultMap) => {
      for (const unitId in resultMap) {
        const unitMap = resultMap[unitId];
        if (this._instanceService.getUnitType(unitId) !== UniverType.UNIVER_SHEET) continue;
        for (const subUnitId in unitMap) {
          const results = unitMap[subUnitId];
...
DataValidationFormulaService = __decorate2([
  __decorateParam2(0, IUniverInstanceService),
  __decorateParam2(1, Inject(RegisterOtherFormulaService)),
  __decorateParam2(2, Inject(DataValidationCacheService)),
  __decorateParam2(3, Inject(DataValidationModel)),
  __decorateParam2(4, Inject(DataValidatorRegistryService)),
  __decorateParam2(5, Inject(DataValidationListCacheService))
], DataValidationFormulaService);
var RuleMatrix = class RuleMatrix2 {
  constructor(value, _unitId, _subUnitId, _univerInstanceService, _disableTree = false) {
    ...
    _defineProperty2(this, "_map", void 0);
    _defineProperty2(this, "_tree", new RBush());
    _defineProperty2(this, "_dirty", true);
    _defineProperty2(this, "_buildTree", () => {
    ...
    _defineProperty2(this, "_debonceBuildTree", debounce_default(this._buildTree, 0));
    this._map = value;
    this._buildTree();
  }
  get _worksheet() {
    var _this$_univerInstance;
    return (_this$_univerInstance = this._univerInstanceService.getUnit(this._unitId, UniverType.UNIVER_SHEET)) === null || _this$_univerInstance === void 0 ? void 0 : _this$_univerInstance.getSheetBySheetId(this._subUnitId);
  }
  ...
  clone() {
    return new RuleMatrix2(new Map(Tools.deepClone(Array.from(this._map.entries()))), this._unitId, this._subUnitId, this._univerInstanceService, true);
  }
  getValue(row, col) {
...
var SheetDataValidationModel = class SheetDataValidationModel2 extends Disposable {
  constructor(_dataValidationModel, _univerInstanceService, _dataValidatorRegistryService, _dataValidationCacheService, _dataValidationFormulaService, _dataValidationCustomFormulaService, _commandService) {
    ...
    this._commandService = _commandService;
    _defineProperty2(this, "_ruleMatrixMap", /* @__PURE__ */ new Map());
    _defineProperty2(this, "_validStatusChange$", new Subject());
    _defineProperty2(this, "_ruleChange$", new Subject());
    _defineProperty2(this, "ruleChange$", this._ruleChange$.asObservable());
    _defineProperty2(this, "validStatusChange$", this._validStatusChange$.asObservable());
...
SheetDataValidationModel = __decorate2([
  __decorateParam2(0, Inject(DataValidationModel)),
  __decorateParam2(1, IUniverInstanceService),
  __decorateParam2(2, Inject(DataValidatorRegistryService)),
  __decorateParam2(3, Inject(DataValidationCacheService)),
  __decorateParam2(4, Inject(DataValidationFormulaService)),
  __decorateParam2(5, Inject(DataValidationCustomFormulaService)),
...
var FORMULA1$1 = "{FORMULA1}";
var FORMULA2$1 = "{FORMULA2}";
var TYPE2 = "{TYPE}";
var BaseSheetValidator = class extends BaseDataValidator {
  ...
  generateRuleName(rule) {
    var _rule$formula, _rule$formula2;
    if (!rule.operator) return this.localeService.t(OperatorTitleMap2.NONE).replace(TYPE2, this.titleStr);
    const ruleName = this.localeService.t(OperatorTitleMap2[rule.operator]).replace(FORMULA1$1, (_rule$formula = rule.formula1) !== null && _rule$formula !== void 0 ? _rule$formula : "").replace(FORMULA2$1, (_rule$formula2 = rule.formula2) !== null && _rule$formula2 !== void 0 ? _rule$formula2 : "");
    return `${this.titleStr} ${ruleName}`;
  }
  generateRuleErrorMessage(rule, _position) {
    var _rule$formula3, _rule$formula4;
    if (!rule.operator) return this.localeService.t(OperatorErrorTitleMap2.NONE).replace(TYPE2, this.titleStr);
    return `${this.localeService.t(OperatorErrorTitleMap2[rule.operator]).replace(FORMULA1$1, (_rule$formula3 = rule.formula1) !== null && _rule$formula3 !== void 0 ? _rule$formula3 : "").replace(FORMULA2$1, (_rule$formula4 = rule.formula2) !== null && _rule$formula4 !== void 0 ? _rule$formula4 : "")}`;
  }
};
...
var CheckboxValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.CHECKBOX);
    _defineProperty2(this, "title", "sheets-data-validation.checkbox.title");
    _defineProperty2(this, "operators", []);
    _defineProperty2(this, "scopes", ["sheet"]);
    _defineProperty2(this, "order", 41);
    _defineProperty2(this, "offsetFormulaByRange", false);
    _defineProperty2(this, "_formulaService", this.injector.get(DataValidationFormulaService));
    _defineProperty2(this, "skipDefaultFontRender", (rule, cellValue, pos) => {
...
var TWO_FORMULA_OPERATOR_COUNT2 = [DataValidationOperator.BETWEEN, DataValidationOperator.NOT_BETWEEN];
...
var transformDate2SerialNumber = (value) => {
  ...
  const v = (_numfmt$parseDate = lib_exports.parseDate(value)) === null || _numfmt$parseDate === void 0 ? void 0 : _numfmt$parseDate.v;
  if (Tools.isDefine(v)) return v;
  return (_numfmt$parseDate2 = lib_exports.parseDate(dateKit(value).format("YYYY-MM-DD HH:mm:ss"))) === null || _numfmt$parseDate2 === void 0 ? void 0 : _numfmt$parseDate2.v;
};
var DateValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.DATE);
    _defineProperty2(this, "title", "sheets-data-validation.date.title");
    _defineProperty2(this, "order", 40);
    _defineProperty2(this, "operators", [
    ...
    _defineProperty2(this, "scopes", ["sheet"]);
    _defineProperty2(this, "_customFormulaService", this.injector.get(DataValidationCustomFormulaService));
    _defineProperty2(this, "_lexerTreeBuilder", this.injector.get(LexerTreeBuilder));
  }
  ...
  async isValidType(info) {
    ...
    if (typeof value === "number" && typeof interceptValue === "string") return Boolean(lib_exports.parseDate(interceptValue));
    if (typeof interceptValue === "string") return Boolean(lib_exports.parseDate(interceptValue));
    return false;
  }
  ...
  validatorFormula(rule, unitId, subUnitId) {
    ...
    if (TWO_FORMULA_OPERATOR_COUNT2.includes(operator)) {
  ...
  normalizeFormula(rule, _unitId, _subUnitId) {
    ...
    const normlizeSingleFormula = (formula) => {
      ...
      let date;
      if (!Number.isNaN(+formula)) date = lib_exports.dateFromSerial(+formula);
      else {
        var _numfmt$parseDate3;
        const res = (_numfmt$parseDate3 = lib_exports.parseDate(formula)) === null || _numfmt$parseDate3 === void 0 ? void 0 : _numfmt$parseDate3.v;
  ...
  generateRuleName(rule) {
    ...
    const ruleName = this.localeService.t(DateOperatorTitleMap[rule.operator]).replace(FORMULA12, (_rule$formula = rule.formula1) !== null && _rule$formula !== void 0 ? _rule$formula : "").replace(FORMULA22, (_rule$formula2 = rule.formula2) !== null && _rule$formula2 !== void 0 ? _rule$formula2 : "");
    return `${this.titleStr} ${ruleName}`;
  }
  generateRuleErrorMessage(rule, pos) {
    ...
    return `${this.localeService.t(DateOperatorErrorTitleMap[rule.operator]).replace(FORMULA12, transformedFormula1 !== null && transformedFormula1 !== void 0 ? transformedFormula1 : "").replace(FORMULA22, transformedFormula2 !== null && transformedFormula2 !== void 0 ? transformedFormula2 : "")}`;
  }
};
...
var DecimalValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "_customFormulaService", this.injector.get(DataValidationCustomFormulaService));
    _defineProperty2(this, "id", DataValidationType.DECIMAL);
    _defineProperty2(this, "_lexerTreeBuilder", this.injector.get(LexerTreeBuilder));
    _defineProperty2(this, "title", "sheets-data-validation.decimal.title");
    _defineProperty2(this, "order", 20);
    _defineProperty2(this, "operators", [
      DataValidationOperator.BETWEEN,
      DataValidationOperator.EQUAL,
      DataValidationOperator.GREATER_THAN,
  ...
  generateRuleErrorMessage(rule, position) {
    if (!rule.operator) return this.localeService.t(OperatorErrorTitleMap2.NONE).replace("{TYPE}", this.titleStr);
    const { transformedFormula1, transformedFormula2 } = getTransformedFormula(this._lexerTreeBuilder, rule, position);
    return `${this.localeService.t(OperatorErrorTitleMap2[rule.operator]).replace(FORMULA12, transformedFormula1 !== null && transformedFormula1 !== void 0 ? transformedFormula1 : "").replace(FORMULA22, transformedFormula2 !== null && transformedFormula2 !== void 0 ? transformedFormula2 : "")}`;
  }
};
...
var ListValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "formulaService", this.injector.get(DataValidationFormulaService));
    _defineProperty2(this, "_lexer", this.injector.get(LexerTreeBuilder));
    _defineProperty2(this, "_univerInstanceService", this.injector.get(IUniverInstanceService));
    _defineProperty2(this, "_listCacheService", this.injector.get(DataValidationListCacheService));
    _defineProperty2(this, "order", 50);
    _defineProperty2(this, "offsetFormulaByRange", false);
    _defineProperty2(this, "id", DataValidationType.LIST);
    _defineProperty2(this, "title", "sheets-data-validation.list.title");
    _defineProperty2(this, "operators", []);
    _defineProperty2(this, "scopes", ["sheet"]);
    _defineProperty2(this, "skipDefaultFontRender", (rule) => {
  ...
  validatorFormula(rule, unitId, subUnitId) {
    ...
    const sheetName = (_this$_univerInstance = this._univerInstanceService.getUnit(unitId, UniverType.UNIVER_SHEET)) === null || _this$_univerInstance === void 0 || (_this$_univerInstance = _this$_univerInstance.getSheetBySheetId(subUnitId)) === null || _this$_univerInstance === void 0 ? void 0 : _this$_univerInstance.getName();
  ...
  _getUnitAndSubUnit(currentUnitId, currentSubUnitId) {
    var _ref2, _ref3;
    const workbook = (_ref2 = currentUnitId ? this._univerInstanceService.getUniverSheetInstance(currentUnitId) : void 0) !== null && _ref2 !== void 0 ? _ref2 : this._univerInstanceService.getCurrentUnitOfType(UniverType.UNIVER_SHEET);
...
var TextLengthValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.TEXT_LENGTH);
    _defineProperty2(this, "title", "sheets-data-validation.textLength.title");
    _defineProperty2(this, "_lexerTreeBuilder", this.injector.get(LexerTreeBuilder));
    _defineProperty2(this, "order", 30);
    _defineProperty2(this, "operators", [
      DataValidationOperator.BETWEEN,
      DataValidationOperator.EQUAL,
      DataValidationOperator.GREATER_THAN,
  ...
  generateRuleErrorMessage(rule, pos) {
    if (!rule.operator) return this.titleStr;
    const { transformedFormula1, transformedFormula2 } = getTransformedFormula(this._lexerTreeBuilder, rule, pos);
    return `${this.localeService.t(TextLengthErrorTitleMap[rule.operator]).replace(FORMULA12, transformedFormula1 !== null && transformedFormula1 !== void 0 ? transformedFormula1 : "").replace(FORMULA22, transformedFormula2 !== null && transformedFormula2 !== void 0 ? transformedFormula2 : "")}`;
  }
};
...
var DataValidationFormulaController = class DataValidationFormulaController2 extends Disposable {
  ...
  getFormulaRefCheck(formulaString) {
    ...
    for (let i = 0; i < sequenceNodes.length; i++) {
      ...
      for (let i2 = startRow; i2 <= endRow; i2++) for (let j = startColumn; j <= endColumn; j++) {
        var _targetSheet$getCell;
        const permission = (_targetSheet$getCell = targetSheet.getCell(i2, j)) === null || _targetSheet$getCell === void 0 || (_targetSheet$getCell = _targetSheet$getCell.selectionProtection) === null || _targetSheet$getCell === void 0 ? void 0 : _targetSheet$getCell[0];
...
DataValidationFormulaController = __decorate2([
  __decorateParam2(0, IUniverInstanceService),
  __decorateParam2(1, IPermissionService),
  __decorateParam2(2, Inject(LexerTreeBuilder))
], DataValidationFormulaController);
var name2 = "@univerjs/sheets-data-validation";
var version2 = "0.25.1";
...
var DataValidationFormulaRefRangeController = class DataValidationFormulaRefRangeController2 extends Disposable {
  constructor(_dataValidationModel, _formulaRefRangeService, _validatorRegistryService) {
    ...
    this._validatorRegistryService = _validatorRegistryService;
    _defineProperty2(this, "_disposableMap", /* @__PURE__ */ new Map());
    _defineProperty2(this, "registerRule", (unitId, subUnitId, rule) => {
...
DataValidationFormulaRefRangeController = __decorate2([
  __decorateParam2(0, Inject(SheetDataValidationModel)),
  __decorateParam2(1, Inject(FormulaRefRangeService)),
  __decorateParam2(2, Inject(DataValidatorRegistryService))
], DataValidationFormulaRefRangeController);
var DataValidationRefRangeController = class DataValidationRefRangeController2 extends Disposable {
...
DataValidationRefRangeController = __decorate2([
  __decorateParam2(0, Inject(SheetDataValidationModel)),
  __decorateParam2(1, Inject(Injector)),
  __decorateParam2(2, Inject(RefRangeService)),
  __decorateParam2(3, Inject(DataValidationFormulaService)),
  __decorateParam2(4, Inject(FormulaRefRangeService)),
  __decorateParam2(5, Inject(DataValidatorRegistryService))
], DataValidationRefRangeController);
var SheetDataValidationSheetController = class SheetDataValidationSheetController2 extends Disposable {
  ...
  _initSheetChange() {
    this.disposeWithMe(this._sheetInterceptorService.interceptCommand({ getMutations: (commandInfo) => {
      if (commandInfo.id === RemoveSheetCommand.id) {
        ...
        const unitId = params.unitId || this._univerInstanceService.getCurrentUnitOfType(UniverType.UNIVER_SHEET).getUnitId();
...
SheetDataValidationSheetController = __decorate2([
  __decorateParam2(0, Inject(SheetInterceptorService)),
  __decorateParam2(1, Inject(IUniverInstanceService)),
  __decorateParam2(2, Inject(SheetDataValidationModel))
], SheetDataValidationSheetController);
var AnyValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.ANY);
    _defineProperty2(this, "title", "sheets-data-validation.any.title");
    _defineProperty2(this, "operators", []);
    _defineProperty2(this, "scopes", ["sheet"]);
    _defineProperty2(this, "order", 0);
    _defineProperty2(this, "offsetFormulaByRange", false);
  }
  async parseFormula(rule, unitId, subUnitId) {
    return {
...
var CustomFormulaValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.CUSTOM);
    _defineProperty2(this, "title", "sheets-data-validation.custom.title");
    _defineProperty2(this, "operators", []);
    _defineProperty2(this, "scopes", ["sheet"]);
    _defineProperty2(this, "order", 60);
    _defineProperty2(this, "_customFormulaService", this.injector.get(DataValidationCustomFormulaService));
    _defineProperty2(this, "_lexerTreeBuilder", this.injector.get(LexerTreeBuilder));
  }
  validatorFormula(rule, unitId, subUnitId) {
...
var ListMultipleValidator = class extends ListValidator {
  constructor(..._args) {
    super(..._args);
    _defineProperty2(this, "id", DataValidationType.LIST_MULTIPLE);
    _defineProperty2(this, "title", "sheets-data-validation.listMultiple.title");
    _defineProperty2(this, "offsetFormulaByRange", false);
    _defineProperty2(this, "skipDefaultFontRender", () => {
      return true;
    });
  }
};
var WholeValidator = class extends BaseSheetValidator {
  constructor(..._args) {
    ...
    _defineProperty2(this, "_customFormulaService", this.injector.get(DataValidationCustomFormulaService));
    _defineProperty2(this, "_lexerTreeBuilder", this.injector.get(LexerTreeBuilder));
    _defineProperty2(this, "id", DataValidationType.WHOLE);
    _defineProperty2(this, "title", "sheets-data-validation.whole.title");
    _defineProperty2(this, "order", 10);
    _defineProperty2(this, "operators", [
      DataValidationOperator.BETWEEN,
      DataValidationOperator.EQUAL,
      DataValidationOperator.GREATER_THAN,
...
var DataValidationController = class DataValidationController2 extends RxDisposable {
...
DataValidationController = __decorate2([
  __decorateParam2(0, IUniverInstanceService),
  __decorateParam2(1, Inject(DataValidatorRegistryService)),
  __decorateParam2(2, Inject(Injector)),
  __decorateParam2(3, Inject(SheetsSelectionsService)),
  __decorateParam2(4, Inject(SheetInterceptorService)),
  __decorateParam2(5, Inject(SheetDataValidationModel))
], DataValidationController);
var SheetsDataValidationValidatorService = class SheetsDataValidationValidatorService2 extends Disposable {
  ...
  _initRecalculate() {
    const handleDirtyRanges = (ranges) => {
      ...
      ranges.flat().forEach((range) => {
        ...
        const workbook2 = this._univerInstanceService.getUnit(range.unitId, UniverType.UNIVER_SHEET);
        const worksheet2 = workbook2 === null || workbook2 === void 0 ? void 0 : workbook2.getSheetBySheetId(range.subUnitId);
        if (!worksheet2) return;
      ...
      Object.entries(map).forEach(([unitId, subUnitMap]) => {
        Object.entries(subUnitMap).forEach(([subUnitId, ranges2]) => {
          if ((workbook === null || workbook === void 0 ? void 0 : workbook.getUnitId()) === unitId && (worksheet === null || worksheet === void 0 ? void 0 : worksheet.getSheetId()) === subUnitId) this.validatorRanges(unitId, subUnitId, ranges2);
...
SheetsDataValidationValidatorService = __decorate2([
  __decorateParam2(0, IUniverInstanceService),
  __decorateParam2(1, Inject(SheetDataValidationModel)),
  __decorateParam2(2, Inject(DataValidationCacheService)),
  __decorateParam2(3, Inject(LifecycleService))
], SheetsDataValidationValidatorService);
var UniverSheetsDataValidationPlugin = class UniverSheetsDataValidationPlugin2 extends Plugin {
...
_defineProperty2(UniverSheetsDataValidationPlugin, "pluginName", DATA_VALIDATION_PLUGIN_NAME2);
_defineProperty2(UniverSheetsDataValidationPlugin, "packageName", name2);
_defineProperty2(UniverSheetsDataValidationPlugin, "version", version2);
_defineProperty2(UniverSheetsDataValidationPlugin, "type", UniverType.UNIVER_SHEET);
UniverSheetsDataValidationPlugin = __decorate2([
  DependentOn(UniverSheetsFormulaPlugin, UniverDataValidationPlugin),
  __decorateParam2(1, Inject(Injector)),
  __decorateParam2(2, ICommandService),
  __decorateParam2(3, IConfigService)
...
//# sourceMappingURL=chunk-FZXUE4SM.js.map
