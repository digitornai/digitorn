...
var InitializerSymbol$1 = Symbol("initializers");
...
var _FBlob;
var FBlob = _FBlob = class FBlob2 extends FBase {
  ...
  */
  getBytes() {
    if (!this._blob) return Promise.reject(new Error("Blob is undefined or null."));
...
var FEnum = class FEnum2 {
  static get() {
    if (this._instance) return this._instance;
    const instance = new FEnum2();
  ...
  */
  ...
  constructor() {
    for (const key in FEnum2.prototype) this[key] = FEnum2.prototype[key];
  }
  /**
...
var FEventName = class FEventName2 {
  static get() {
    if (this._instance) return this._instance;
    const instance = new FEventName2();
    this._instance = instance;
    return instance;
  }
  /**
  ...
  */
  ...
  constructor() {
    for (const key in FEventName2.prototype) this[key] = FEventName2.prototype[key];
  }
  /**
...
var FHooks = class FHooks2 extends FBase {
...
var FDoc = class FDoc2 extends FBaseInitialable {
...
var FUserManager = class FUserManager2 extends FBase {
...
var FUtil = class FUtil2 {
  static get() {
    if (this._instance) return this._instance;
    const instance = new FUtil2();
    this._instance = instance;
    return instance;
  }
  /**
...
var FUniver = _FUniver = class FUniver2 extends Disposable {
  /**
  ...
  */
  ...
  _initUnitEvent(injector) {
    ...
    this.disposeWithMe(this.registerEventHandler(this.Event.DocDisposed, () => univerInstanceService.unitDisposed$.subscribe((unit) => {
      if (unit.type === UniverType.UNIVER_DOC) this.fireEvent(this.Event.DocDisposed, {
    ...
    this.disposeWithMe(this.registerEventHandler(this.Event.DocCreated, () => univerInstanceService.unitAdded$.subscribe((event) => {
      const { unit } = event;
      if (unit.type === UniverType.UNIVER_DOC) {
        const doc = unit;
...
//# sourceMappingURL=chunk-YVJOJ6TY.js.map
