...
export declare class DataField {
    ...
    /**
     * get field type, used to distinguish between group field and data field, the original data field type is normal field.
     * @returns {PivotDataFieldTypeEnum} the data field type
     */
