...
export declare function convertArrayLikeRangeInfoToMatrix(sourceRange: IRange, sheet: Worksheet, index: number, matrix: ObjectMatrix<Nullable<string | number | null>>, matrixType: ObjectMatrix<ChartSourceDataTypeEnum>, styles: Styles): void;
/**
