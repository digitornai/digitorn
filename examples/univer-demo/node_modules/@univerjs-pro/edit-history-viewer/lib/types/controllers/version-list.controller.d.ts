...
export declare class VersionListController extends Disposable {
    ...
    constructor(_sidebarService: ISidebarService, _componentManager: ComponentManager, _localeService: LocaleService, _historyManagerService: HistoryManagerService, _configService: IConfigService);
    private _init;
    private _openPanel;
    private _initPanel;
}
