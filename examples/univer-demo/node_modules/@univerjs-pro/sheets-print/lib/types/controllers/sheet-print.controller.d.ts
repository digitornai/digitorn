...
import { ComponentManager, IMenuManagerService, IShortcutService, IZenZoneService } from '@univerjs/ui';
...
export declare class SheetPrintController extends Disposable {
    ...
    constructor(_printService: IZenZoneService, _commandService: ICommandService, _sheetPrintManagerService: ISheetPrintManagerService, _sheetPrintClientService: SheetPrintClientService, _componentManager: ComponentManager, _menuManagerService: IMenuManagerService, _shortcutService: IShortcutService, _injector: Injector, _univerInstanceService: IUniverInstanceService, _renderManagerService: IRenderManagerService);
    private _initialize;
    ...
    private _initPrintGridExtension;
