...
export interface IMovePivotFieldCommandParams {
    ...
    pivotTableId: string;
    /**
     * @property {string} fieldId  The field id. Which is the field id of pivot table.
     */
    fieldId: string;
    /**
     * @property {PivotTableFiledAreaEnum} area  The field area to move the data field.
     */
    area: PivotTableFiledAreaEnum;
    /**
     * @property {number} index  The index to move the data field. Which is base-on 0.
     */
    index: number;
}
