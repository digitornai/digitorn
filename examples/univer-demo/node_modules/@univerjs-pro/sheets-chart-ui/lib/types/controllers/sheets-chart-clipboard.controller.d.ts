...
export declare class SheetsChartClipboardController extends Disposable {
    ...
    private _copyInfo;
    constructor(_sheetSkeletonService: SheetSkeletonService, _sheetClipboardService: ISheetClipboardService, _sheetDrawingService: ISheetDrawingService, _chartModelService: ChartModelService);
