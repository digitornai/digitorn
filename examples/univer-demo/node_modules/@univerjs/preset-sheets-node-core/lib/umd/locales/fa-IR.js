...
// @univerjs/sheets-hyper-link/locale/fa-IR
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkFaIR=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`محدوده نامعتبر`}}}});

// locale/fa-IR
(function(e,i){typeof exports=="object"&&typeof module<"u"?module.exports=i(require("@univerjs/core"),require("@univerjs/sheets/locale/fa-IR"),require("@univerjs/sheets-data-validation/locale/fa-IR"),require("@univerjs/sheets-filter/locale/fa-IR"),require("@univerjs/sheets-formula/locale/fa-IR"),require("@univerjs/sheets-hyper-link/locale/fa-IR")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/fa-IR","@univerjs/sheets-data-validation/locale/fa-IR","@univerjs/sheets-filter/locale/fa-IR","@univerjs/sheets-formula/locale/fa-IR","@univerjs/sheets-hyper-link/locale/fa-IR"],i):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreFaIR=i(e.UniverCore,e.UniverSheetsFaIR,e.UniverSheetsDataValidationFaIR,e.UniverSheetsFilterFaIR,e.UniverSheetsFormulaFaIR,e.UniverSheetsHyperLinkFaIR))})(this,(function(e,i,r,s,n,t){"use strict";return e.mergeLocales(i,r,s,n,t)}));
