...
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsFrFR=t())})(this,function(){return{sheets:{tabs:{sheetCopy:`(Copie{0})`,sheet:`Feuille`},info:{overlappingSelections:`Impossible d'utiliser cette commande sur des sélections qui se chevauchent`,acrossMergedCell:`À travers une cellule fusionnée`,partOfCell:`Seule une partie d'une cellule fusionnée est sélectionnée`,hideSheet:`Aucune feuille visible après avoir masqué celle-ci`},definedName:{nameEmpty:`Le nom ne peut pas être vide`,nameDuplicate:`Le nom existe déjà`,nameInvalid:`Le nom est invalide`,nameSheetConflict:`Le nom entre en conflit avec le nom de la feuille`,formulaOrRefStringEmpty:`La formule ou la chaîne de référence ne peut pas être vide`,nameConflict:`Le nom entre en conflit avec le nom de la fonction`,defaultName:`NomDéfini`},permission:{dialog:{autoFillErr:`La plage est protégée, et vous n'avez pas la permission pour le remplissage automatique. Pour utiliser le remplissage automatique, veuillez contacter le créateur.`,editErr:`La plage est protégée, et vous n'avez pas la permission de modifier. Pour modifier, veuillez contacter le créateur.`,formulaErr:`La plage ou la plage référencée est protégée, et vous n'avez pas la permission de modifier. Pour modifier, veuillez contacter le créateur.`,insertOrDeleteMoveRangeErr:`La plage insérée ou supprimée intersecte la plage protégée, et cette opération n'est pas supportée pour le moment.`,insertRowColErr:`La plage est protégée, et vous n'avez pas la permission d'insérer des lignes et des colonnes. Pour insérer des lignes et des colonnes, veuillez contacter le créateur.`,moveRangeErr:`La plage est protégée, et vous n'avez pas la permission de déplacer la sélection. Pour déplacer la sélection, veuillez contacter le créateur.`,moveRowColErr:`La plage est protégée, et vous n'avez pas la permission de déplacer les lignes et les colonnes. Pour déplacer les lignes et les colonnes, veuillez contacter le créateur.`,operatorSheetErr:`La feuille de calcul est protégée, et vous n'avez pas la permission de travailler sur la feuille de calcul. Pour travailler sur la feuille de calcul, veuillez contacter le créateur.`,removeRowColErr:`La plage est protégée, et vous n'avez pas la permission de supprimer les lignes et les colonnes. Pour supprimer les lignes et les colonnes, veuillez contacter le créateur.`,setRowColStyleErr:`La plage est protégée, et vous n'avez pas la permission de définir les styles de ligne et de colonne. Pour définir les styles de ligne et de colonne, veuillez contacter le créateur.`,setStyleErr:`La plage est protégée, et vous n'avez pas la permission de définir les styles. Pour définir les styles, veuillez contacter le créateur.`}},autoFill:{copy:`Copier la cellule`,series:`Remplir la série`,formatOnly:`Format uniquement`,noFormat:`Aucun format`},merge:{confirm:{title:`Continuer la fusion ne conservera que la valeur de la cellule en haut à gauche, en supprimant les autres valeurs. Êtes-vous sûr de vouloir continuer ?`,cancel:`Annuler la fusion`,confirm:`Continuer la fusion`,warning:`Avertissement`,dismantleMergeCellWarning:`Cela divisera certaines cellules fusionnées. Voulez-vous continuer ?`}}}}});

// @univerjs/sheets-data-validation/locale/fr-FR
...
// @univerjs/sheets-filter/locale/fr-FR
...
// @univerjs/sheets-hyper-link/locale/fr-FR
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkFrFR=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`Plage invalide`}}}});

// locale/fr-FR
(function(e,r){typeof exports=="object"&&typeof module<"u"?module.exports=r(require("@univerjs/core"),require("@univerjs/sheets/locale/fr-FR"),require("@univerjs/sheets-data-validation/locale/fr-FR"),require("@univerjs/sheets-filter/locale/fr-FR"),require("@univerjs/sheets-formula/locale/fr-FR"),require("@univerjs/sheets-hyper-link/locale/fr-FR")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/fr-FR","@univerjs/sheets-data-validation/locale/fr-FR","@univerjs/sheets-filter/locale/fr-FR","@univerjs/sheets-formula/locale/fr-FR","@univerjs/sheets-hyper-link/locale/fr-FR"],r):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreFrFR=r(e.UniverCore,e.UniverSheetsFrFR,e.UniverSheetsDataValidationFrFR,e.UniverSheetsFilterFrFR,e.UniverSheetsFormulaFrFR,e.UniverSheetsHyperLinkFrFR))})(this,(function(e,r,i,s,n,t){"use strict";return e.mergeLocales(r,i,s,n,t)}));
