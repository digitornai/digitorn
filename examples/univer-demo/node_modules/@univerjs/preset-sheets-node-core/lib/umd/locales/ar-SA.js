// @univerjs/sheets/locale/ar-SA
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsArSA=t())})(this,function(){return{sheets:{tabs:{sheetCopy:`(نسخ{0})`,sheet:`ورقة`},info:{overlappingSelections:`لا يمكن استخدام هذا الأمر على التحديدات المتداخلة`,acrossMergedCell:`عبر خلية مدمجة`,partOfCell:`تم تحديد جزء فقط من خلية مدمجة`,hideSheet:`لا توجد ورقة مرئية بعد إخفاء هذه الورقة`},definedName:{nameEmpty:`لا يمكن أن يكون الاسم فارغًا`,nameDuplicate:`الاسم موجود بالفعل`,nameInvalid:`الاسم غير صالح`,nameSheetConflict:`يتعارض الاسم مع اسم الورقة`,formulaOrRefStringEmpty:`لا يمكن أن تكون الصيغة أو سلسلة المرجع فارغة`,nameConflict:`يتعارض الاسم مع اسم الدالة`,defaultName:`اسم معرّف`},permission:{dialog:{autoFillErr:`النطاق محمي، وليس لديك إذن للتعبئة التلقائية. لاستخدام التعبئة التلقائية، يرجى الاتصال بالمنشئ.`,editErr:`النطاق محمي، وليس لديك إذن التحرير. للتحرير، يرجى الاتصال بالمنشئ.`,formulaErr:`النطاق أو النطاق المُشار إليه محمي، وليس لديك إذن التحرير. للتحرير، يرجى الاتصال بالمنشئ.`,insertOrDeleteMoveRangeErr:`يتقاطع النطاق المدرج أو المحذوف مع النطاق المحمي، وهذه العملية غير مدعومة حاليًا.`,insertRowColErr:`النطاق محمي، وليس لديك إذن لإدراج صفوف وأعمدة. لإدراج صفوف وأعمدة، يرجى الاتصال بالمنشئ.`,moveRangeErr:`النطاق محمي، وليس لديك إذن لنقل التحديد. لنقل التحديد، يرجى الاتصال بالمنشئ.`,moveRowColErr:`النطاق محمي، وليس لديك إذن لنقل الصفوف والأعمدة. لنقل الصفوف والأعمدة، يرجى الاتصال بالمنشئ.`,operatorSheetErr:`ورقة العمل محمية، وليس لديك إذن لتشغيل ورقة العمل. لتشغيل ورقة العمل، يرجى الاتصال بالمنشئ.`,removeRowColErr:`النطاق محمي، وليس لديك إذن لحذف الصفوف والأعمدة. لحذف الصفوف والأعمدة، يرجى الاتصال بالمنشئ.`,setRowColStyleErr:`النطاق محمي، وليس لديك إذن لتعيين أنماط الصفوف والأعمدة. لتعيين أنماط الصفوف والأعمدة، يرجى الاتصال بالمنشئ.`,setStyleErr:`النطاق محمي، وليس لديك إذن لتعيين الأنماط. لتعيين الأنماط، يرجى الاتصال بالمنشئ.`}},autoFill:{copy:`نسخ الخلية`,series:`تعبئة السلسلة`,formatOnly:`التنسيق فقط`,noFormat:`بدون تنسيق`},merge:{confirm:{title:`سيؤدي الاستمرار في الدمج إلى الاحتفاظ بقيمة الخلية العلوية اليسرى فقط، وسيتم تجاهل القيم الأخرى. هل أنت متأكد من الاستمرار؟`,cancel:`إلغاء الدمج`,confirm:`الاستمرار في الدمج`,warning:`تحذير`,dismantleMergeCellWarning:`سيؤدي هذا إلى تقسيم بعض الخلايا المدمجة. هل تريد الاستمرار؟`}}}}});

// @univerjs/sheets-data-validation/locale/ar-SA
...
// @univerjs/sheets-filter/locale/ar-SA
...
// @univerjs/sheets-hyper-link/locale/ar-SA
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkArSA=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`نطاق غير صالح`}}}});

// locale/ar-SA
(function(e,r){typeof exports=="object"&&typeof module<"u"?module.exports=r(require("@univerjs/core"),require("@univerjs/sheets/locale/ar-SA"),require("@univerjs/sheets-data-validation/locale/ar-SA"),require("@univerjs/sheets-filter/locale/ar-SA"),require("@univerjs/sheets-formula/locale/ar-SA"),require("@univerjs/sheets-hyper-link/locale/ar-SA")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/ar-SA","@univerjs/sheets-data-validation/locale/ar-SA","@univerjs/sheets-filter/locale/ar-SA","@univerjs/sheets-formula/locale/ar-SA","@univerjs/sheets-hyper-link/locale/ar-SA"],r):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreArSA=r(e.UniverCore,e.UniverSheetsArSA,e.UniverSheetsDataValidationArSA,e.UniverSheetsFilterArSA,e.UniverSheetsFormulaArSA,e.UniverSheetsHyperLinkArSA))})(this,(function(e,r,i,s,n,t){"use strict";return e.mergeLocales(r,i,s,n,t)}));
