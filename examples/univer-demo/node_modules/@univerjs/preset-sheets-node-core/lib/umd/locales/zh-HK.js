// @univerjs/sheets/locale/zh-HK
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsZhHK=t())})(this,function(){return{sheets:{tabs:{sheetCopy:`（副本{0}）`,sheet:`工作表`},info:{overlappingSelections:`無法對重疊選區使用該命令`,acrossMergedCell:`無法跨越合併儲存格`,partOfCell:`僅選擇了合併儲存格的一部份`,hideSheet:`隱藏後無可見工作表`},definedName:{nameEmpty:`名稱不能為空`,nameDuplicate:`名稱已存在`,nameInvalid:`名稱無效`,nameSheetConflict:`名稱與工作表名稱衝突`,formulaOrRefStringEmpty:`公式或引用字串不能為空`,nameConflict:`名稱與函數名稱衝突`,defaultName:`DefinedName`},permission:{dialog:{autoFillErr:`範圍已被保護，目前無自動填入權限。如需自動填充，請聯絡建立者。 `,editErr:`該範圍已被保護，目前無編輯權限。如需編輯，請聯絡創建者。 `,formulaErr:`該範圍或引用範圍已被保護，目前無編輯權限。如需編輯，請聯絡創建者。 `,insertOrDeleteMoveRangeErr:`插入、刪除區域與保護範圍相交，暫不支援此操作。 `,insertRowColErr:`該範圍已被保護，目前無插入欄列權限。如需插入欄列，請聯絡創作者。 `,moveRangeErr:`該範圍已被保護，目前無移動選取範圍權限。如需移動選區，請聯絡創作者。 `,moveRowColErr:`該範圍已被保護，目前無移動欄列權限。如需行動欄列，請聯絡創作者。 `,operatorSheetErr:`該工作表已被保護，目前無操作工作表權限。如需操作工作表，請聯絡創建者。 `,removeRowColErr:`該範圍已被保護，目前無刪除欄列權限。如需刪除欄列，請聯絡創作者。 `,setRowColStyleErr:`該範圍已被保護，目前無設定欄列樣式權限。如需設定欄列樣式，請聯絡建立者。 `,setStyleErr:`該範圍已被保護，目前無設定樣式權限。如需設定樣式，請聯絡建立者。 `}},autoFill:{copy:`複製儲存格`,series:`填入數列`,formatOnly:`僅格式`,noFormat:`無格式`},merge:{confirm:{title:`繼續合併將只保留左上角儲存格的值，捨棄其他值。您確定要繼續嗎？`,cancel:`取消合併`,confirm:`繼續合併`,warning:`警告`,dismantleMergeCellWarning:`這將導致一些合併儲存格被拆分。您要繼續嗎？`}}}}});

// @univerjs/sheets-data-validation/locale/zh-HK
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsDataValidationZhHK=t())})(this,function(){return{"sheets-data-validation":{operators:{between:`介於`,greaterThan:`大於`,greaterThanOrEqual:`大於或等於`,lessThan:`小於`,lessThanOrEqual:`小於或等於`,equal:`等於`,notEqual:`不等於`,notBetween:`未介於`,legal:`是合法類型`},ruleName:{between:`介於 {FORMULA1} 和 {FORMULA2} 之間`,greaterThan:`大於 {FORMULA1}`,greaterThanOrEqual:`大於或等於 {FORMULA1}`,lessThan:`小於 {FORMULA1}`,lessThanOrEqual:`小於或等於 {FORMULA1}`,equal:`等於 {FORMULA1}`,notEqual:`不等於 {FORMULA1}`,notBetween:`在 {FORMULA1} 和 {FORMULA2} 範圍之外`,legal:`是一個合法的 {TYPE}`},errorMsg:{between:`值必須介於 {FORMULA1} 和 {FORMULA2} 之間`,greaterThan:`值必須大於 {FORMULA1}`,greaterThanOrEqual:`值必須大於或等於 {FORMULA1}`,lessThan:`值必須小於 {FORMULA1}`,lessThanOrEqual:`值必須小於或等於 {FORMULA1}`,equal:`值必須等於 {FORMULA1}`,notEqual:`值必須不等於 {FORMULA1}`,notBetween:`值必須在 {FORMULA1} 和 {FORMULA2} 範圍之外`,legal:`值必須是一個合法的 {TYPE}`},date:{operators:{between:`介於`,greaterThan:`晚於`,greaterThanOrEqual:`晚於或等於`,lessThan:`早於`,lessThanOrEqual:`早於或等於`,equal:`等於`,notEqual:`不等於`,notBetween:`未介於`,legal:`是合法日期`},ruleName:{between:`介於 {FORMULA1} 和 {FORMULA2} 之間`,greaterThan:`晚於 {FORMULA1}`,greaterThanOrEqual:`晚於或等於 {FORMULA1}`,lessThan:`早於 {FORMULA1}`,lessThanOrEqual:`早於或等於 {FORMULA1}`,equal:`等於 {FORMULA1}`,notEqual:`不等於 {FORMULA1}`,notBetween:`在 {FORMULA1} 和 {FORMULA2} 範圍之外`,legal:`是一個合法的日期`},errorMsg:{between:`日期必須介於 {FORMULA1} 和 {FORMULA2} 之間`,greaterThan:`日期必須晚於 {FORMULA1}`,greaterThanOrEqual:`日期必須晚於或等於 {FORMULA1}`,lessThan:`日期必須早於 {FORMULA1}`,lessThanOrEqual:`早於或等於 {FORMULA1}`,equal:`日期必須等於 {FORMULA1}`,notEqual:`日期必須不等於 {FORMULA1}`,notBetween:`日期必須在 {FORMULA1} 和 {FORMULA2} 範圍之外`,legal:`值必須是一個合法的日期`},title:`日期`},textLength:{errorMsg:{between:`文字長度必須介於 {FORMULA1} 和 {FORMULA2} 之間`,greaterThan:`文字長度必須大於 {FORMULA1}`,greaterThanOrEqual:`文字長度必須大於或等於 {FORMULA1}`,lessThan:`文字長度必須小於 {FORMULA1}`,lessThanOrEqual:`文字長度必須小於或等於 {FORMULA1}`,equal:`文字長度必須等於 {FORMULA1}`,notEqual:`文字長度必須不等於 {FORMULA1}`,notBetween:`文字長度必須在 {FORMULA1} 和 {FORMULA2} 範圍之外`},title:`文字長度`},custom:{ruleName:`自訂公式 {FORMULA1}`,title:`自訂公式`,validFail:`請輸入合法的公式`,error:`此儲存格的內容違反了驗證規則`},validFail:{value:`請輸入一個合法值`,common:`請輸入數值或公式`,number:`請輸入合法的數字或公式`,formula:`請輸入合法的公式`,integer:`請輸入合法的整數或公式`,date:`請輸入合法的日期或公式`,list:`請輸入至少一個合法選項`,listInvalid:`清單來源必須是分隔清單或單列或欄的參考。 `,checkboxEqual:`為勾選和未勾選的儲存格內容輸入不同的值。 `,formulaError:`引用範圍內包含不可見的數據，請重新調整範圍`,listIntersects:`所選範圍不能和規則範圍相交`,primitive:`自訂勾選和未勾選值不允許使用公式。 `},any:{title:`任意值`,error:`此儲存格的內容違反了驗證規則`},list:{title:`下拉選單`,name:`值必須是列表中的值`,error:`輸入必須在指定的範圍內`,emptyError:`請輸入一個值`,add:`新增選項`,dropdown:`單選`,options:`選項來源`,customOptions:`自訂`,refOptions:`引用資料`,formulaError:`列表來源必須是劃定分界後的資料列表,或是對單一列或欄的引用。`,edit:`編輯`},listMultiple:{title:`下拉式選單-多選`,dropdown:`多選`},decimal:{title:`數字`},whole:{title:`整數`},checkbox:{title:`複選框`,error:`此儲存格的內容違反了驗證規則`,tips:`在儲存格內使用自訂值`,checked:`選取值`,unchecked:`未選取值`}}}});
...
// @univerjs/sheets-hyper-link/locale/zh-HK
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkZhHK=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`錯誤的引用`}}}});

// locale/zh-HK
(function(e,i){typeof exports=="object"&&typeof module<"u"?module.exports=i(require("@univerjs/core"),require("@univerjs/sheets/locale/zh-HK"),require("@univerjs/sheets-data-validation/locale/zh-HK"),require("@univerjs/sheets-filter/locale/zh-HK"),require("@univerjs/sheets-formula/locale/zh-HK"),require("@univerjs/sheets-hyper-link/locale/zh-HK")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/zh-HK","@univerjs/sheets-data-validation/locale/zh-HK","@univerjs/sheets-filter/locale/zh-HK","@univerjs/sheets-formula/locale/zh-HK","@univerjs/sheets-hyper-link/locale/zh-HK"],i):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreZhHK=i(e.UniverCore,e.UniverSheetsZhHK,e.UniverSheetsDataValidationZhHK,e.UniverSheetsFilterZhHK,e.UniverSheetsFormulaZhHK,e.UniverSheetsHyperLinkZhHK))})(this,(function(e,i,r,s,n,h){"use strict";return e.mergeLocales(i,r,s,n,h)}));
