// @univerjs/sheets/locale/id-ID
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsIdID=t())})(this,function(){return{sheets:{tabs:{sheetCopy:`(Salin{0})`,sheet:`Lembar`},info:{overlappingSelections:`Tidak dapat menggunakan perintah tersebut pada pilihan yang tumpang tindih`,acrossMergedCell:`Melintasi sel gabungan`,partOfCell:`Hanya sebagian sel gabungan yang dipilih`,hideSheet:`Tidak ada lembar yang terlihat setelah Anda menyembunyikan ini`},definedName:{nameEmpty:`Nama tidak boleh kosong`,nameDuplicate:`Nama sudah ada`,nameInvalid:`Nama tidak valid`,nameSheetConflict:`Nama bertentangan dengan nama lembar`,formulaOrRefStringEmpty:`Rumus atau string referensi tidak boleh kosong`,nameConflict:`Nama bertentangan dengan nama fungsi`,defaultName:`NamaTerdefinisi`},permission:{dialog:{autoFillErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk pengisian otomatis. Untuk menggunakan pengisian otomatis, silakan hubungi pembuatnya.`,editErr:`Rentang dilindungi, dan Anda tidak memiliki izin edit. Untuk mengedit, silakan hubungi pembuatnya.`,formulaErr:`Rentang atau rentang yang direferensikan dilindungi, dan Anda tidak memiliki izin edit. Untuk mengedit, silakan hubungi pembuatnya.`,insertOrDeleteMoveRangeErr:`Rentang yang disisipkan atau dihapus berpotongan dengan rentang yang dilindungi, dan operasi ini belum didukung.`,insertRowColErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk menyisipkan baris dan kolom. Untuk menyisipkan baris dan kolom, silakan hubungi pembuatnya.`,moveRangeErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk memindahkan pilihan. Untuk memindahkan pilihan, silakan hubungi pembuatnya.`,moveRowColErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk memindahkan baris dan kolom. Untuk memindahkan baris dan kolom, silakan hubungi pembuatnya.`,operatorSheetErr:`Lembar kerja dilindungi, dan Anda tidak memiliki izin untuk mengoperasikan lembar kerja. Untuk mengoperasikan lembar kerja, silakan hubungi pembuatnya.`,removeRowColErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk menghapus baris dan kolom. Untuk menghapus baris dan kolom, silakan hubungi pembuatnya.`,setRowColStyleErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk mengatur gaya baris dan kolom. Untuk mengatur gaya baris dan kolom, silakan hubungi pembuatnya.`,setStyleErr:`Rentang dilindungi, dan Anda tidak memiliki izin untuk mengatur gaya. Untuk mengatur gaya, silakan hubungi pembuatnya.`}},autoFill:{copy:`Salin Sel`,series:`Isi Seri`,formatOnly:`Hanya Format`,noFormat:`Tanpa Format`},merge:{confirm:{title:`Melanjutkan penggabungan hanya akan menyimpan nilai sel kiri atas, membuang nilai lainnya. Apakah Anda yakin ingin melanjutkan?`,cancel:`Batalkan penggabungan`,confirm:`Lanjutkan penggabungan`,warning:`Peringatan`,dismantleMergeCellWarning:`Ini akan menyebabkan beberapa sel gabungan terpisah. Apakah Anda ingin melanjutkan?`}}}}});

// @univerjs/sheets-data-validation/locale/id-ID
...
// @univerjs/sheets-filter/locale/id-ID
...
// @univerjs/sheets-hyper-link/locale/id-ID
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkIdID=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`Rentang Tidak Valid`}}}});

// locale/id-ID
(function(e,i){typeof exports=="object"&&typeof module<"u"?module.exports=i(require("@univerjs/core"),require("@univerjs/sheets/locale/id-ID"),require("@univerjs/sheets-data-validation/locale/id-ID"),require("@univerjs/sheets-filter/locale/id-ID"),require("@univerjs/sheets-formula/locale/id-ID"),require("@univerjs/sheets-hyper-link/locale/id-ID")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/id-ID","@univerjs/sheets-data-validation/locale/id-ID","@univerjs/sheets-filter/locale/id-ID","@univerjs/sheets-formula/locale/id-ID","@univerjs/sheets-hyper-link/locale/id-ID"],i):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreIdID=i(e.UniverCore,e.UniverSheetsIdID,e.UniverSheetsDataValidationIdID,e.UniverSheetsFilterIdID,e.UniverSheetsFormulaIdID,e.UniverSheetsHyperLinkIdID))})(this,(function(e,i,r,s,n,t){"use strict";return e.mergeLocales(i,r,s,n,t)}));
