// @univerjs/sheets/locale/pl-PL
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsPlPL=t())})(this,function(){return{sheets:{tabs:{sheetCopy:`(Kopia {0})`,sheet:`Arkusz`},info:{overlappingSelections:`Nie można użyć tego polecenia na nakładających się zaznaczeniach`,acrossMergedCell:`Przez scaloną komórkę`,partOfCell:`Zaznaczono tylko część scalonej komórki`,hideSheet:`Po ukryciu tego arkusza nie będzie widocznych arkuszy`},definedName:{nameEmpty:`Nazwa nie może być pusta`,nameDuplicate:`Nazwa już istnieje`,nameInvalid:`Nazwa jest nieprawidłowa`,nameSheetConflict:`Nazwa jest w konflikcie z nazwą arkusza`,formulaOrRefStringEmpty:`Formuła lub ciąg odwołania nie może być pusty`,nameConflict:`Nazwa jest w konflikcie z nazwą funkcji`,defaultName:`ZdefiniowanaNazwa`},permission:{dialog:{autoFillErr:`Zakres jest chroniony i nie masz uprawnień do autowypełniania. Aby użyć autowypełniania, skontaktuj się z twórcą.`,editErr:`Zakres jest chroniony i nie masz uprawnień do edycji. Aby edytować, skontaktuj się z twórcą.`,formulaErr:`Zakres lub zakres odwołania jest chroniony i nie masz uprawnień do edycji. Aby edytować, skontaktuj się z twórcą.`,insertOrDeleteMoveRangeErr:`Wstawiony lub usunięty zakres przecina się z chronionym zakresem i ta operacja nie jest obecnie obsługiwana.`,insertRowColErr:`Zakres jest chroniony i nie masz uprawnień do wstawiania wierszy i kolumn. Aby wstawić wiersze i kolumny, skontaktuj się z twórcą.`,moveRangeErr:`Zakres jest chroniony i nie masz uprawnień do przenoszenia zaznaczenia. Aby przenieść zaznaczenie, skontaktuj się z twórcą.`,moveRowColErr:`Zakres jest chroniony i nie masz uprawnień do przenoszenia wierszy i kolumn. Aby przenieść wiersze i kolumny, skontaktuj się z twórcą.`,operatorSheetErr:`Arkusz jest chroniony i nie masz uprawnień do operowania na arkuszu. Aby operować na arkuszu, skontaktuj się z twórcą.`,removeRowColErr:`Zakres jest chroniony i nie masz uprawnień do usuwania wierszy i kolumn. Aby usunąć wiersze i kolumny, skontaktuj się z twórcą.`,setRowColStyleErr:`Zakres jest chroniony i nie masz uprawnień do ustawiania stylów wierszy i kolumn. Aby ustawić style wierszy i kolumn, skontaktuj się z twórcą.`,setStyleErr:`Zakres jest chroniony i nie masz uprawnień do ustawiania stylów. Aby ustawić style, skontaktuj się z twórcą.`}},autoFill:{copy:`Kopiuj komórkę`,series:`Wypełnij serią`,formatOnly:`Tylko format`,noFormat:`Bez formatu`},merge:{confirm:{title:`Kontynuowanie scalania spowoduje zachowanie tylko wartości komórki w lewym górnym rogu, pozostałe wartości zostaną odrzucone. Czy na pewno chcesz kontynuować?`,cancel:`Anuluj scalanie`,confirm:`Kontynuuj scalanie`,warning:`Ostrzeżenie`,dismantleMergeCellWarning:`Spowoduje to rozdzielenie niektórych scalonych komórek. Czy chcesz kontynuować?`}}}}});

// @univerjs/sheets-data-validation/locale/pl-PL
...
// @univerjs/sheets-hyper-link/locale/pl-PL
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkPlPL=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`Nieprawidłowy zakres`}}}});

// locale/pl-PL
(function(e,i){typeof exports=="object"&&typeof module<"u"?module.exports=i(require("@univerjs/core"),require("@univerjs/sheets/locale/pl-PL"),require("@univerjs/sheets-data-validation/locale/pl-PL"),require("@univerjs/sheets-filter/locale/pl-PL"),require("@univerjs/sheets-formula/locale/pl-PL"),require("@univerjs/sheets-hyper-link/locale/pl-PL")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/pl-PL","@univerjs/sheets-data-validation/locale/pl-PL","@univerjs/sheets-filter/locale/pl-PL","@univerjs/sheets-formula/locale/pl-PL","@univerjs/sheets-hyper-link/locale/pl-PL"],i):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCorePlPL=i(e.UniverCore,e.UniverSheetsPlPL,e.UniverSheetsDataValidationPlPL,e.UniverSheetsFilterPlPL,e.UniverSheetsFormulaPlPL,e.UniverSheetsHyperLinkPlPL))})(this,(function(e,i,r,s,l,n){"use strict";return e.mergeLocales(i,r,s,l,n)}));
