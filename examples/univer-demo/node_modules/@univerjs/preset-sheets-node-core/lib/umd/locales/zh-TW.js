...
// @univerjs/sheets-hyper-link/locale/zh-TW
(function(e,t){typeof exports==`object`&&typeof module<`u`?module.exports=t():typeof define==`function`&&define.amd?define([],t):(e=typeof globalThis<`u`?globalThis:e||self,e.UniverSheetsHyperLinkZhTW=t())})(this,function(){return{"sheets-hyper-link":{message:{refError:`錯誤的引用`}}}});

// locale/zh-TW
(function(e,i){typeof exports=="object"&&typeof module<"u"?module.exports=i(require("@univerjs/core"),require("@univerjs/sheets/locale/zh-TW"),require("@univerjs/sheets-data-validation/locale/zh-TW"),require("@univerjs/sheets-filter/locale/zh-TW"),require("@univerjs/sheets-formula/locale/zh-TW"),require("@univerjs/sheets-hyper-link/locale/zh-TW")):typeof define=="function"&&define.amd?define(["@univerjs/core","@univerjs/sheets/locale/zh-TW","@univerjs/sheets-data-validation/locale/zh-TW","@univerjs/sheets-filter/locale/zh-TW","@univerjs/sheets-formula/locale/zh-TW","@univerjs/sheets-hyper-link/locale/zh-TW"],i):(e=typeof globalThis<"u"?globalThis:e||self,e.UniverPresetSheetsNodeCoreZhTW=i(e.UniverCore,e.UniverSheetsZhTW,e.UniverSheetsDataValidationZhTW,e.UniverSheetsFilterZhTW,e.UniverSheetsFormulaZhTW,e.UniverSheetsHyperLinkZhTW))})(this,(function(e,i,r,s,n,h){"use strict";return e.mergeLocales(i,r,s,n,h)}));
