...
export declare class DataValidationCopyPasteController extends Disposable {
    ...
    private _copyInfo;
    constructor(_sheetClipboardService: ISheetClipboardService, _sheetDataValidationModel: SheetDataValidationModel, _injector: Injector, _univerInstanceService: IUniverInstanceService);
