...
export declare class SheetsDrawingCopyPasteController extends Disposable {
    ...
    private _copyInfo;
    constructor(_sheetClipboardService: ISheetClipboardService, _renderManagerService: IRenderManagerService, _sheetSkeletonService: SheetSkeletonService, _drawingService: IDrawingManagerService, _clipboardInterfaceService: IClipboardInterfaceService, _commandService: ICommandService);
