...
type ContextBlock struct {
	Sections []ContextSection `yaml:"sections,omitempty" json:"sections,omitempty"`
}
...
type ContextSection struct {
	...
	File     string   `yaml:"file,omitempty" json:"file,omitempty"`     // single file (relative to workdir or absolute)
	Files    []string `yaml:"files,omitempty" json:"files,omitempty"`    // multiple files — merged with file:
	Dir      string   `yaml:"dir,omitempty" json:"dir,omitempty"`      // load all *.md files from this directory
	Optional bool     `yaml:"optional,omitempty" json:"optional,omitempty"` // silently skip missing/unreadable files
	Writable bool     `yaml:"writable,omitempty" json:"writable,omitempty"` // agent may write back — injects memory writing directive
